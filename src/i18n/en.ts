export const en: Record<string, string> = {
  ...
  'student.auxCameraSwitch': 'Switch camera',
  'student.auxCameraFront': 'Front',
  'student.auxCameraRear': 'Rear',
  'student.auxPlaybackFailed': 'Camera playback failed. Please retry.',
  ...
  'parent.noDataShort': '—',
  'parent.syncingData': 'Syncing student data...',
  'parent.syncFailed': 'Cannot fetch student data. Please verify the link code.',
  'parent.studentName': 'Student',
  'parent.lastSync': 'Last sync',
  ...
  'pet.stateGood': 'Good Posture',
  'pet.stateSlouch': 'Back Warning',
  'pet.stateClose': 'Too Close',
  'pet.stateWriting': 'Writing',
  'pet.stateTired': 'Tired',
  'pet.stateSuccess': 'Completed',
  'pet.stateSleep': 'Resting',
  'pet.dialogueGood': 'Awesome! Keep up this posture!',
  'pet.dialogueSlouch': 'Oops, your back is too curved! Sit up straight!',
  'pet.dialogueClose': 'You are sitting too close to the screen!',
  'pet.dialogueWriting': 'Focusing on writing, Oliver will be quiet...',
  'pet.dialogueTired': 'Oliver notices your neck seems tired, give it a little stretch!',
  'pet.dialogueSuccess': 'Congratulations on reaching your goal!',
  'pet.dialogueSleep': 'Zzz... Oliver is resting...',
  'pet.dialogueDefault': 'Oliver is always by your side!',
  ...
  'shop.category.head': 'Hats',
  'shop.category.eyes': 'Glasses',
  'shop.category.body': 'Capes',
  'shop.category.aura': 'Auras',
  'shop.category.hat': 'Hats',
  'shop.category.accessory': 'Accessories',
  'shop.category.background': 'Auras',
  'shop.equip': 'Equipped',
  'shop.buy': 'Buy',
  'shop.buyWithCoins': 'Coins',
  'shop.fittingRoom': 'Fitting Room',
  'shop.equipped': 'Equipped',
  'shop.owned': 'Owned',
  'shop.buySuccess': 'Item purchased successfully! 🎉',
  'shop.notEnoughCoins': 'Not enough Coins to buy this item!',

  // Item names (Pet Shop)
  'shop.item.hat_scholar': 'Scholar Hat',
  'shop.item.hat_crown_silver': 'Silver Crown',
  'shop.item.hat_crown_gold': 'Gold Crown',
  'shop.item.eyes_glasses': 'Wisdom Glasses',
  'shop.item.eyes_sunglasses': 'Cool Sunglasses',
  'shop.item.body_cape': 'Red Cape',
  'shop.item.aura_fire': 'Fire Aura',
  'shop.item.aura_ice': 'Ice Aura',
  'shop.item.aura_electric': 'Electric Aura',

  // Student toasts / broadcasts
  'student.leveledUp': 'Congratulations! You leveled up!',
  ...
  'eyeExercise.step1Highlight': 'head (nose)',
  'eyeExercise.step2': '2. Blink 4 times to relax your eyes.',
  'eyeExercise.step2Highlight': 'Blink 4 times',
